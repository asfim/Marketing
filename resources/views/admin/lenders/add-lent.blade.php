...
@section('breadcrumb', 'New Lending')
            ...
            <div class="col-md-10">
                <div class="head clearfix">
                    <div>
                        ...
                        <h1>Receive Lending from {{ $lender->name }}</h1>
                    </div>
                </div>

                <div class="block-fluid clearfix">
                    <form action="{{ route('admin.lenders.saveLoan') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="footer" style="text-align: center;">
                                <button type="submit" class="btn btn-primary">Save Lending</button>
