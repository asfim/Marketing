...
@section('content')
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4>Investor</h4>
            <a href="{{ route('admin.investors.create') }}" class="btn btn-primary">Add Investor</a>
        </div>
            ...
            <div class="card">
                <div class="block-fluid table-sorting clearfix">
                    ...
                    @forelse($investors as $key => $investor)
                        @php
                            $credit = DB::table('investor_statements')->where('investor_id', $investor->id)->sum('credit');
                            $debit = DB::table('investor_statements')->where('investor_id', $investor->id)->sum('debit');
                        @endphp
                        <tr>
                            ...
                            <td class="hidden-print">
                                ...
                                <!-- View Button -->
                                <a href="{{ route('admin.investors.show', $investor->id) }}" title="View Investor">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.edit-btn').on('click', function () {
                ...
                $('#editInvestorForm').attr('action', '{{ url('investor/update') }}/' + id);
            ...
            $('.delete-btn').on('click', function () {
                let id = $(this).data('id');
                $('#deleteInvestorForm').attr('action', '{{ url('investor/delete') }}/' + id);
