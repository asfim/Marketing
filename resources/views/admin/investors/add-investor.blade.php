            ...
            <div class="col-md-10">
                <div class="head clearfix">
                    <div>
                        ...
                        <h1>Receive Investor from {{ $investor->name }}</h1>
                    </div>
                </div>

                <div class="block-fluid clearfix">
                    <form action="{{ route('admin.investors.saveInvestment') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
