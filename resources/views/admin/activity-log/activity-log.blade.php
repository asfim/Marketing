...
<header>
    <div class="name">
        ...
        <img src="{{ asset("assets/images/".$settings['logo']) }}" class="img-thumbnail" width="80"/>
        {{--<span>user</span>--}}
...
<section class="content">
    <div class="top_content">
        ...
        <div class="top_content_right">
            ...
            <div class="filter_item">
                ...
                <select ng-model="filter.log_name">
        ...
        <div class="responsive_table">
            <table>
                ...
                <tr ng-repeat="log in data |filter: selectedType track by $index">
                    ...
                    <td>@{{ log.log_name }}</td>
                    <td ng-switch="log.description">
                        <span ng-switch-when="deleted" class="badge emergency">@{{log.description}}</span>

                        <span ng-switch-when="created" class="badge info">@{{log.description}}</span>
                        <span ng-switch-when="created" class="lbl_table"></span>
                        <span ng-switch-when="updated" class="badge warning">@{{log.description}}</span>

                        <span ng-switch-when="updated|deleted"
                              ng-switch-when-separator="|" class="lbl_table"></span>

                        <span ng-switch-default class="badge debug">@{{log.description}}</span>
                    </td>
    ...
    {{--<footer>--}}
        ...
        {{--<div class="footer_right">--}}
            {{--<span class="text_light">Delete data older than {{ config('activitylog.delete_records_older_than_days') }} days</span>--}}
            ...
            <div class="popup_content">
                <table style="width: 96%;">
                    ...
                    <tr>
                        ...
                        <td ng-switch="selected.description">
                            <span ng-switch-when="deleted"
                                  ng-switch-when-separator="|" class="badge emergency">@{{selected.description}}</span>

                            <span ng-switch-when="created" class="badge info">@{{selected.description}}</span>
                            <span ng-switch-when="updated" class="badge warning">@{{selected.description}}</span>
                            <span ng-switch-default class="badge debug">@{{selected.description}}</span>
                        </td>
                    </tr>
                    <tr>
                ...
                <div class="responsive_table">
                    <table style="width: 96%;">
                        ...
                        <tr>
                            <td>FIELD</td>
                            <td>@{{ selected.description==='updated'?'CURRENT':'DATA' }}</td>
                            <td ng-show="selected.description==='updated'">PREVIOUS</td>
                        </tr>
                        </thead>
                        <tbody>

                        <tr ng-repeat="(field,value) in selected.properties.attributes">
                            <td class="field_cell">@{{ field }}</td>
                            <td>@{{ value }}</td>
                            <td ng-show="selected.description==='updated'">
                ...
                <br>
                {{--<div class="responsive_table" ng-if="selected.log_name==='updated' && editHistory.length > 0">--}}
    ...
    @include('admin.activity-log.script')
</section>
