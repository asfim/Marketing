...
@section('title', 'View General Incomes')
@section('breadcrumb', 'View General Incomes')
<?php $user = Auth::user(); ?>
                            ...
                            <tr>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            @foreach ($files as $file)
                                                @if($file != "")
                                                    <li><a href="{{ URL::to('/img/files/income_files/general/'.$file) }}" target="_blank" rel="tag">{{ $file }}</a></li>
                                               @endif
                                            @endforeach
                                        </ul>
                                    </div>
                                ...
                                @if($user->hasRole('super-admin') || $user->can('edit-income'))
                                    <a role="button" class="edit-btn"
                                       data-id="{{$income->id}}"
                                       data-transaction_id="{{$income->transaction_id}}"
