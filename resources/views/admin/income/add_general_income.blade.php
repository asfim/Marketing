...
@section('title', 'Add General Income')
@section('breadcrumb', 'Add General Income')
<?php $user = Auth::user(); ?>
            ...
            <div class="col-md-12">
                <div class="head clearfix">
                    <div class="col-md-4">
                        ...
                        <h1>Add General Income</h1>
                    </div>
                </div>
                <div class="block-fluid clearfix">
                    <form action="{{ route('income.general.store') }}" method="post" enctype="multipart/form-data" id="gen_income_form" class="form-horizontal">
                        {{csrf_field()}}
