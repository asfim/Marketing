...
@section('title', 'Return Investment')
@section('breadcrumb', 'Return Investment')
            ...
            <div class="col-md-10">
                <div class="head clearfix">
                    <div class="col-md-4">
                        ...
                        <h1>Return Investment for: {{ $investor->name }}</h1>
                    </div>
                </div>

                <div class="block-fluid clearfix">
                    <form action="{{ route('investments.return.process', $investor->id) }}" method="POST" class="form-horizontal">
                        @csrf
