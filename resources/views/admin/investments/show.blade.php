        ...
        <div id="investor-profile-tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
            ...
            <div class="head clearfix" style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <ul class="buttons ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all"
                    ...
                    <li class="ui-state-default ui-corner-top {{ $selected_tab == 'tab-investor-info' ? 'ui-tabs-active ui-state-active' : '' }}"
                        role="tab">
                        <a href="#tab-investor-info" class="ui-tabs-anchor"><i class="glyphicon glyphicon-user"></i>
                            Investor Info</a>
                    </li>
                    <li class="ui-state-default ui-corner-top {{ $selected_tab == 'tab-return-history' ? 'ui-tabs-active ui-state-active' : '' }}"
                        role="tab">
                        <a href="#tab-return-history" class="ui-tabs-anchor"><i class="glyphicon glyphicon-repeat"></i>
                            Return History</a>
                    </li>
                    <li class="ui-state-default ui-corner-top {{ $selected_tab == 'tab-investment-history' ? 'ui-tabs-active ui-state-active' : '' }}"
                        role="tab">
                        <a href="#tab-investment-history" class="ui-tabs-anchor"><i class="glyphicon glyphicon-usd"></i>
                            Investment History</a>
                    </li>
                    <li class="ui-state-default ui-corner-top {{ $selected_tab == 'tab-investment-statement' ? 'ui-tabs-active ui-state-active' : '' }}"
                        role="tab">
                        <a href="#tab-investment-statement" class="ui-tabs-anchor"><i
                                class="glyphicon glyphicon-list"></i>Statements</a>
                    </li>
                </ul>
                ...
                <div class="action-buttons" style="display: flex; gap: 10px;">
                    ...
                    <a href="{{ route('admin.investments.addInvestment', $investor->id) }}" class="btn inline-btn">
                        <i class="glyphicon glyphicon-minus"></i> Invest
                    </a>

                    <a href="{{ route('investments.return.form', $investor->id) }}" class="btn inline-btn btn-warning">
            ...
            {{-- Investment Info --}}
            <div id="tab-investor-info"
                class="ui-tabs-panel ui-widget-content ui-corner-bottom {{ $selected_tab == 'tab-investor-info' ? '' : 'ui-helper-hidden' }}">
                <div class="row">
                    <div class="col-md-4">
            ...
            {{-- Return History --}}
            <div id="tab-return-history"
                class="ui-tabs-panel ui-widget-content ui-corner-bottom {{ $selected_tab == 'tab-return-history' ? '' : 'ui-helper-hidden' }}">
                <div class="row">
                    <div class="col-md-12">
                        {{-- Header --}}
                            ...
                            <div class="col-md-4">
                                <h3>
                                    ...
                                    <span class="src-info">
                                        ...
                                        <span
                                            class="src-info">{{ request('investment_search_text') == '' && request('return_date_range') == '' ? '- Last 30 Days' : '- ' . request('return_date_range') }}</span>
                                    </span>
                                </h3>
                            </div>
                            <div class="col-md-8 search_box" style="margin-top: 4px;">
                                <form action="" class="form-horizontal">
                                    ...
                                    <div class="" align="right">
                                        <div class="col-md-6">
                                            <input type="text" name="return_search_text" class="form-control"
                                                value="{{ request('return_search_text') ?? '' }}"
                                                placeholder="Search note or method" />
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <input type="text" name="return_date_range"
                                                    value="{{ request('return_date_range') ?? '' }}"
                                ...
                                <tbody>
                                    ...
                                    @forelse ($investmentHistory as $index => $return)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (strtolower($return->deposit_type) === 'bank')
                                                    {{ $return->bank_name }}
                                            ...
                                            <td>{{ $return->description ?? 'N/A' }}</td>
                                             ...
                                             @if(auth()->user()->hasRole(['super-admin']))
                                                ...
                                                <td><form action="{{ route('investment.return.destroy', $return->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center text-muted">No investment history
                                                available.</td>
                                        </tr>
                                    @endforelse
            ...
            {{-- Investment History --}}
            <div id="tab-investment-history"
                class="ui-tabs-panel ui-widget-content ui-corner-bottom {{ $selected_tab == 'tab-investment-history' ? '' : 'ui-helper-hidden' }}">
                <div class="row">
                    <div class="col-md-12">
                        {{-- Header --}}
                        <div class="head clearfix">
                            <div class="col-md-4">
                                ...
                                <h3>
                                    ...
                                    <span class="src-info">
                                        ...
                                        <span
                                            class="src-info">{{ request('investment_search_text') == '' && request('investment_date_range') == '' ? '- Last 30 Days' : '- ' . request('investment_date_range') }}</span>
                                    </span>
                                </h3>
                            </div>
                            <div class="col-md-8 search_box" style="margin-top: 4px;">
                                <form action="" class="form-horizontal">
                                    ...
                                    <div class="" align="right">
                                        <div class="col-md-6">
                                            <input type="text" name="investment_search_text" class="form-control"
                                                value="{{ request('investment_search_text') ?? '' }}"
                                                placeholder="Search description" />
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <input type="text" name="investment_date_range"
                                                    value="{{ request('investment_date_range') ?? '' }}"
                                                    class="date_range form-control" placeholder="Date Range"
                                                    autocomplete="off" />
                                                <div class="input-group-btn">
                                                    <button type="submit"
                        ...
                        <div class="block-fluid table-sorting clearfix">
                            <table class="table" width="100%">
                                ...
                                <tbody>
                                    ...
                                    @forelse ($returnHistory as $index => $return)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ ucfirst($return->description ?? 'N/A') }}</td>
                                             @if(auth()->user()->hasRole(['super-admin']))
                                            <td><form action="{{ route('investment.history.destroy', $return->id) }}" 
                                                method="POST"
                                                onsubmit="return confirm('Are you sure you want to delete this return history?');">
                                                @csrf
                                                @method('DELETE')
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center text-muted">No return history available.
                                            </td>
                                        </tr>
                                    @endforelse
            ...
            <div id="tab-investment-statement"
                class="ui-tabs-panel ui-widget-content ui-corner-bottom {{ $selected_tab == 'tab-investment-statement' ? '' : 'ui-helper-hidden' }}">
                <div class="row">
                    <div class="col-md-12">
                        {{-- Header --}}
                        <div class="head clearfix">
                        ...
                        <div class="block-fluid table-sorting clearfix">
                            <table class="table" width="100%">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="8" class="text-center text-muted">No lender statements found.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
