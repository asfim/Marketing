...
@section('title', 'Monthly Customer Report')
@section('breadcrumb', 'Monthly Customer Report')
@section('content')
    <div class="workplace">
        <div class="row">
            <div class="col-md-12">
                <div class="head clearfix">
                    ...
                    <div class="col-md-8 search_box" style="margin-top: 4px; float: right;">
                        <form action="{{ route('monthly.report.index') }}" method="GET" class="form-horizontal">
                            <input type="text" placeholder="Enter Customer Name" name="search_name" ... />
                            ...
                            <tbody>
                                ...
                                @foreach ($customerReports as $report)
                                    @php
                                        ...
                                        $total_qty_cum += floatval(str_replace(',', '', $report['qty_cum']));
