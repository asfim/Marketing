<div class="header hidden-print">
    <a class="logo" href="{{ route('admin.home') }}" style="font-weight: bold; text-transform: uppercase; font-size: 20px; color: #fff; text-decoration: none;">
        {{ $settings['company_name'] }}
        {{--<img src="{{asset('img/logo1.png')}}" alt="ccl-admin" title="ccl"/>--}}
    </a>
        ...
        <form action="{{ route('search') }}">
            <div class="top-search-box">
                ...
                <div class="input-group">
                    <input id="appendedInputButton" value="{{ request('g_search_text')??'' }}" name="g_search_text" placeholder="Customer/Supplier name, mobile" class="form-control" type="text">
                    <div class="input-group-btn">
                        <button class="btn btn-primary" type="submit" style="border: 1px solid #fff">Search</button>
                    </div>
                </div>
    ...
    <ul class="header_menu" style="margin: -37px 0 0 0;">
