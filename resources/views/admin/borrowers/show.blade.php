...
@section('content')
    <div class="workplace">
        ...
        {{-- Tabs --}}
        <div id="borrower-profile-tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
            {{-- Tab Nav --}}
            <div class="head clearfix" style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <ul class="buttons ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist" style="margin-bottom: 0;">
                    <li class="ui-state-default ui-corner-top {{ $selected_tab=='tab-borrower-info' ? 'ui-tabs-active ui-state-active' : '' }}" role="tab">
                ...
                <div class="action-buttons" style="display: flex; gap: 10px;">
                    ...
                    <a href="{{ route('admin.borrowers.addLoan', $borrower->id) }}" class="btn inline-btn">
                        <i class="glyphicon glyphicon-plus"></i> Borrow Loan
                    </a>

                    <a href="{{ route('borrowers.return.form', $borrower->id) }}" class="btn inline-btn btn-warning">
            ...
            {{-- Borrower Info --}}
            <div id="tab-borrower-info" class="ui-tabs-panel ui-widget-content ui-corner-bottom {{ $selected_tab=='tab-borrower-info' ? '' : 'ui-helper-hidden' }}">
                <div class="row">
                    <div class="col-md-4">
                        <div class="block ucard">
                            <div class="info">
                                <ul class="rows">
                                    <li class="heading">Borrower Info</li>
                                    <li>
                                        <div class="title">Name:</div>
                                        <div class="text">{{ $borrower->name }}</div>
                                    </li>
                                    <li>
                                        <div class="title">Phone:</div>
                                        <div class="text">{{ $borrower->phone }}</div>
                                    </li>
                                    <li>
                                        <div class="title">Address:</div>
                                        <div class="text">{{ $borrower->address }}</div>
                                    </li>
                                ...
                                @forelse ($returnHistory as $index => $return)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('borrower.return.delete', $return->id) }}" 
                                            method="POST"
                            ...
                            <table class="table" width="100%">
                                ...
                                @forelse ($investmentHistory as $index => $loan)
                                    ...
                                    <tr>
                                        ...
                                        <td>@if (strtolower($loan->deposit_type) === 'bank')
                                                    {{ $loan->bank_name }}
                                                @elseif(strtolower($loan->deposit_type) === 'cash')
                                                    Cash
                                                @else
                                                    {{ $loan->deposit_type ?? 'N/A' }}
                                                @endif</td>
                                        <td>{{ $loan->description ?? 'N/A' }}</td>

                                        @if(auth()->user()->hasRole(['super-admin']))
                                            <td>
                                                <form action="{{ route('borrower.history.delete', $loan->id) }}" 
                                                    method="POST"
                                                    onsubmit="return confirm('Are you sure you want to delete this return history?');">
                                                    @csrf
                                                    @method('DELETE')
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="block-fluid table-sorting clearfix">
                            <table class="table" width="100%">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8" class="text-center text-muted">No borrower statements found.</td>
                                    </tr>
                                @endforelse
                                </tbody>
