...
@section('title', 'View Production Expenses')
@section('breadcrumb', 'View Production Expenses')
<?php $user = Auth::user(); ?>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="table" id="datatable">
                        ...
                        @foreach($expenses as $expense)
                            <tr>
                                ...
                                <td>{{($expense->branch) ? $expense->branch->branchName : ''}}</td>
                                <td>
                                    <div class="btn-group">
                        ...
                        <tr style="background-color:#999999; color: #fff;">
                            ...
                            <td></td>
                            <td><b>Total:</b></td>
                            <td><b>{{ 'BDT '. number_format($ex_total,2) }}</b></td>
                            <td></td>
                            <td></td>
                            <td></td>
